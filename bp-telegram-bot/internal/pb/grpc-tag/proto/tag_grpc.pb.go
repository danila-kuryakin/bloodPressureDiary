...
const (
	TagService_CreateTag_FullMethodName = "/message.TagService/CreateTag"
	TagService_UpdateTag_FullMethodName = "/message.TagService/UpdateTag"
	TagService_DeleteTag_FullMethodName = "/message.TagService/DeleteTag"
	TagService_ListTag_FullMethodName   = "/message.TagService/ListTag"
)
...
type TagServiceClient interface {
	CreateTag(ctx context.Context, in *UserTagRequest, opts ...grpc.CallOption) (*TagResponse, error)
	UpdateTag(ctx context.Context, in *UserTagRequest, opts ...grpc.CallOption) (*TagResponse, error)
	DeleteTag(ctx context.Context, in *DeleteTagRequest, opts ...grpc.CallOption) (*TagResponse, error)
	ListTag(ctx context.Context, in *ListTagRequest, opts ...grpc.CallOption) (*ListUserTagRequest, error)
}
...
func (c *tagServiceClient) CreateTag(ctx context.Context, in *UserTagRequest, opts ...grpc.CallOption) (*TagResponse, error) {
...
func (c *tagServiceClient) UpdateTag(ctx context.Context, in *UserTagRequest, opts ...grpc.CallOption) (*TagResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TagResponse)
...
func (c *tagServiceClient) DeleteTag(ctx context.Context, in *DeleteTagRequest, opts ...grpc.CallOption) (*TagResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TagResponse)
...
func (c *tagServiceClient) ListTag(ctx context.Context, in *ListTagRequest, opts ...grpc.CallOption) (*ListUserTagRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUserTagRequest)
...
type TagServiceServer interface {
	CreateTag(context.Context, *UserTagRequest) (*TagResponse, error)
	UpdateTag(context.Context, *UserTagRequest) (*TagResponse, error)
	DeleteTag(context.Context, *DeleteTagRequest) (*TagResponse, error)
	ListTag(context.Context, *ListTagRequest) (*ListUserTagRequest, error)
...
func (UnimplementedTagServiceServer) CreateTag(context.Context, *UserTagRequest) (*TagResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTag not implemented")
}
func (UnimplementedTagServiceServer) UpdateTag(context.Context, *UserTagRequest) (*TagResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateTag not implemented")
}
func (UnimplementedTagServiceServer) DeleteTag(context.Context, *DeleteTagRequest) (*TagResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteTag not implemented")
}
func (UnimplementedTagServiceServer) ListTag(context.Context, *ListTagRequest) (*ListUserTagRequest, error) {
...
func _TagService_CreateTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).CreateTag(ctx, req.(*UserTagRequest))
	}
...
func _TagService_UpdateTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).UpdateTag(ctx, req.(*UserTagRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "message.TagService",
